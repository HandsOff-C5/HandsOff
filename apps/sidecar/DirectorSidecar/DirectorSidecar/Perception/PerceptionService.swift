...
final class PerceptionService {
    ...
    ///
    /// Uses `NSScreen.screens.first` (the menu-bar / primary display), NOT `NSScreen.main` — the
    /// latter is the screen with the KEY WINDOW, which drifts with focus (see CoordinateSpace.swift).
