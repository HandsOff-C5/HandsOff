...
export function Dashboard({
  ...
  useEffect(() => {
    ...
    // We're on the eye-gaze path now: the on-screen "Eye tracking" card (webview
    // FaceLandmarker, top-right) is the debug view. Start head-track in absolute mode
    // (still feeds head pose) but do NOT open the Swift head-track debug WINDOW — its
    // nose/eye/line preview was being mistaken for the eye tracker. Re-enable via
    // Settings → Head Tracking Debug if you need the head-pose preview.
