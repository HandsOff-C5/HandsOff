...
fn main() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::cua_pixel::cua_screenshot,
            commands::cua_pixel::cua_cursor_position,
            commands::cua_pixel::cua_pointer_move,
            commands::cua_pixel::cua_pointer_click,
            commands::cua_pixel::cua_pointer_drag,
            commands::cua_pixel::cua_pointer_button,
            commands::cua_pixel::cua_scroll,
            commands::cua_pixel::cua_type,
            commands::cua_pixel::cua_key,
            commands::cua_pixel::cua_hold_key,
